    ...
    setMessages([
      {
        id: "welcome",
        sender: "bot",
        text: "Chat cleared successfully! 🧼\n\nI'm ready for your new questions about the SMILE Grade 9 English textbook. Ask me anything!",
        timestamp: new Date()
      }
    ]);
    window.speechSynthesis.cancel();
            ...
            <div className="bg-gradient-to-r from-indigo-600 via-violet-600 to-indigo-700 text-white p-4 flex items-center justify-between border-b-2 border-indigo-200 shadow-sm shrink-0">
              <div className="flex items-center gap-2.5">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] sm:text-[11px] font-bold text-indigo-100/80">Grade 9 English Assistant</p>
                </div>
              </div>
